...
public class SpielerRender extends Render3
{
	...
	public static SpielerRender gib(double dreh, int hoeheA)
	{
		...
		for(int i = 0; i < 4; i++)
			q(teile1, i == 0 ? w1 : w, punkte[i], punkte[(i + 1) % 4], punkte[i + 4], punkte[(i + 1) % 4 + 4]);

		for(int i = 0; i < 4; i++)
			punkte[i + 8] = R3p.dreh(dreh + i / 4d, new R3p(-nb1, nw1, h2), 1 - i % 2);
		for(int i = 0; i < 4; i++)
			punkte[i + 12] = R3p.dreh(dreh + i / 4d, new R3p(-nb1, nw1, h3), 1 - i % 2);
		for(int i = 0; i < 4; i++)
			q(teile1, w, punkte[i + 8], punkte[(i + 1) % 4 + 8], punkte[i + 12], punkte[(i + 1) % 4 + 12]);

		for(int i = 0; i < 2; i++)
			punkte[i + 16] = R3p.dreh(dreh + i / 2d, new R3p(0, nw1, h3), 1);
		for(int i = 0; i < 4; i++)
			punkte[i + 18] = R3p.dreh(dreh + i / 4d, new R3p(-nb1 - fa1, nw1, 0), 1 - i % 2);
		for(int i = 0; i < 4; i++)
			punkte[i + 22] = R3p.dreh(dreh + i / 4d, new R3p(-fa1, nw1, 0), 1 - i % 2);
		...
		for(int i = 0; i < 4; i++)
			punkte[i + 26] = R3p.dreh(dreh + i / 4d, new R3p(-hb1, nw1, h3), 1 - i % 2);
		for(int i = 0; i < 4; i++)
			punkte[i + 30] = R3p.dreh(dreh + i / 4d, new R3p(-hb2, nw1, h3), 1 - i % 2);
		for(int i = 0; i < 4; i++)
			punkte[i + 34] = R3p.dreh(dreh + i / 4d, new R3p(-hb3, nw1, h2), 1 - i % 2);
